...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much Drishty, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much Drishty, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
		...
		if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Happy Anniversary Babe!"], canvas.width / 2, (canvas.height/2 + 120), fontSize, lineHeight);
        } else {
            context.fillText("Happy Anniversary Babe!", canvas.width/2, (canvas.height/2 + 100));
        }
